    ...
    public sealed class Program
    {
        ...
        public static int Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.Console()
#if DEBUG
                .WriteTo.File("epicod-api-log.txt", rollingInterval: RollingInterval.Day)
#endif
                .CreateLogger();

            try
            {
                Log.Information("Starting Epicod host");
                DumpEnvironmentVars();
            ...
            {
                Log.Fatal(ex, "Epicod host terminated unexpectedly");
