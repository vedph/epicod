...
namespace Epicod.Scraper.Packhum.Test
{
    public sealed class PackhumDateParserTest
    {
        ...
        [InlineData("21 AD at the earliest", "21 AD")]
        [InlineData("21 AD (at the earliest)", "21 AD")]
        ...
        [InlineData("init.s.II BC", "c. 190 BC")]
        [InlineData("med.s.II BC", "c. 150 BC")]
        [InlineData("fin.s.II BC", "c. 110 BC")]
        [InlineData("early s.II BC", "c. 185 BC")]
        [InlineData("late s.II BC", "c. 115 BC")]
        [InlineData("1st half s.II BC", "c. 175 BC")]
        [InlineData("2nd half s.II BC", "c. 125 BC")]
        [InlineData("1.Drittel s.II BC", "c. 183 BC")]
        // year span
